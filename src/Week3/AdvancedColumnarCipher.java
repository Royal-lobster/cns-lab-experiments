...
/**
 * Advance Columnar Cipher algorithm that encrypts plaintext by given key
...
public class AdvancedColumnarCipher {
    public static void main(String[] args) {
        // Initialize this object
        AdvancedColumnarCipher obj = new AdvancedColumnarCipher();
        ...
        String i = obj.encrypt(p, row, col, k);
        String c = obj.encrypt(i, row, col, k);
        System.out.println("Intermediate text: " + i);
        System.out.println("Encrypted text: " + c);

        // Decrypt the cipher text
        i = obj.decrypt(c, row, col, k);
        p = obj.decrypt(i, row, col, k);
        System.out.println("Intermediate text: " + i);
