...
/**
 * Blowfish algorithm that encrypts plaintext by given key
...
public class Blowfish {
    ...
    final String S[][] = { { "d1310ba6", "98dfb5ac", "2ffd72db", "d01adfb7", "b8e1afed",
    ...
    private String crypt(String m, String k, boolean isToDecrypt) {
        ...
        // postprocessing
        String right = m.substring(0, 8);
        String left = m.substring(8, 16);
